...
const beginYear:number = 2022;
const endYear:number = 2056;
  ...
  series: [
    {
      ...
      symbolSize: [30, 55],
      symbolRepeat: true,
      data: makeSeriesData(beginYear, false),
...
setInterval(function () {
  ...
  eChartsRef.current?.getEchartsInstance().setOption({
    ...
    series: [
      {
        data: makeSeriesData(currentYear,false)
      },
      {
  ...
  return <ReactECharts option={option} ref={eChartsRef} style={{
    height: '100%',
    width: '100%',
  }} />;
};
